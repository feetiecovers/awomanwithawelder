...
export function TrailerConfiguratorPopup({ isOpen, onClose }: TrailerConfiguratorPopupProps) {
  ...
  const handleSubmitQuote = (e: React.FormEvent) => {
    ...
    const payloadAddress = quoteForm.streetAddress.trim()
      ? `\n[Delivery Address: ${quoteForm.streetAddress.trim()}, ${quoteForm.townCity.trim()}, ${quoteForm.region.trim()} ${quoteForm.postcode.trim()}]`
      : "";
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 overflow-hidden">
        ...
        >
          ...
          <div className="relative flex items-center justify-between px-5 py-3 border-b border-[#ff2a8d]/20 bg-[#16061c]/80 backdrop-blur-md shrink-0">
            ...
            <Button
              ...
              size="icon"
              onClick={onClose}
              className="h-8.5 w-8.5 rounded-full bg-white/5 border border-pink-500/30 text-pink-200 hover:bg-[#ff2a8d]/30 hover:text-white transition-all shadow-[0_0_12px_rgba(255,42,141,0.3)]"
            >
          ...
          <div className="flex-1 overflow-hidden grid grid-cols-1 lg:grid-cols-[1fr_360px] xl:grid-cols-[1fr_390px]">
            ...
            <div className="overflow-hidden flex flex-col justify-between p-3.5 sm:p-5 relative no-scrollbar">
              <AnimatePresence mode="wait">
                {/* PAGE 1: Base Build Model Selection */}
                {currentStep === 1 && (
                  <motion.div
                    key="step-1"
                ...
                {/* PAGE 2: Configure Categories & Options */}
                {currentStep === 2 && (
                  <motion.div
                    key="step-2"
                    initial={{ opacity: 0, x: 20 }}
            ...
            {/* Right Pane (Desktop Summary Sidebar) */}
        ...
        {/* Quote Modal Overlay - Booking Popup Address Layout (Address, Town/City, Region, Post Code) */}
        <AnimatePresence>
          {isQuoteModalOpen && (
              ...
              >
                ...
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmitQuote} className="grid grid-cols-1 md:grid-cols-[340px_1fr] lg:grid-cols-[360px_1fr] gap-5">
                    ...
                    {/* Right Column: Contact & Address Details (Address, Town/City, Region, Post Code) */}
                    <div className="space-y-3 flex flex-col justify-between">
                      <div className="space-y-2.5">
                        ...
                        {/* Address Section: Address, Town/City, Region, Post Code */}
